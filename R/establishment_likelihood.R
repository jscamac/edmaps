...
#'
#' @param total_arrivals A \code{RasterLayer} (or path to raster file)
...
#'   the \code{RasterLayer} will be returned to R.
...
establishment_likelihood <- function(total_arrivals, suitability, outfile, 
  ...
  out <- prod(raster::stack(list(total_arrivals, suitability)))
