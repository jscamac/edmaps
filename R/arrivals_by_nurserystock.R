#' Estimates pest arrivals through imported nursery stock
#'
...
#'   country.
#' @param probability Numeric vector of one or more probabilities that an 
#'   imported nursery stock item carries a pest.
...
#' @export
arrivals_by_nurserystock <- function(pop_density, total_imports, probability,
