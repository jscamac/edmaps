...
#'   from Torres Strait.
#' @param probability Numeric. The probability a Torres Strait passenger carries
#'   a pest.
...
arrivals_by_torres <- function(pop_density, airport_weight, total_passengers,
  ...
  out <-disperse_arrivals(r, total_passengers, probability)
  names(out) <- c("arrivals_by_torres")
