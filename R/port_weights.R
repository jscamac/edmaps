...
#'
#' @param template_raster A `RasterLayer` or path to supported raster
#'   file.
...
#'   `outfile` is not specified the resulting raster is returned,
#'   otherwise `NULL` is returned invisibly.
